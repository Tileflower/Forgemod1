package net.tileflower.tutorialmod.block;
...
import net.tileflower.tutorialmod.block.custom.MagicBlock;
import net.tileflower.tutorialmod.item.Moditems;

import java.util.function.Supplier;
//do I know what any of this does? Hell nah
...
public class ModBlocks {
    ...
    public static final RegistryObject<ButtonBlock> ALEXANDRITE_BUTTON = registerBlock("alexandrite_button",
            () -> new ButtonBlock(BlockSetType.IRON, 10,BlockBehaviour.Properties.of().strength(3f).requiresCorrectToolForDrops().noCollission()));
